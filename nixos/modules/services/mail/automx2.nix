...
in
{
  options = {
    services.automx2 = {
      ...
      package = lib.mkPackageOption pkgs [ "python3Packages" "automx2" ] { };
  ...
  config = lib.mkIf cfg.enable {
    ...
    systemd.services.automx2 = {
      ...
      serviceConfig = {
        ...
        ExecStart = "${pkgs.python3.buildEnv.override { extraLibs = [ cfg.package ]; }}/bin/flask run --host=127.0.0.1 --port=${toString cfg.port}";
        Restart = "always";
